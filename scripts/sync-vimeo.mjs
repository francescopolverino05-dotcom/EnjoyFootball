...
const SECTION_ALIASES = {
  ...
  set_piece: 'set-piece',
  'set-piece': 'set-piece',
  attacking_corners: 'attacking-corners',
  'attacking-corners': 'attacking-corners',
  attacking_corner: 'attacking-corners',
  defending_corners: 'defending-corners',
  'defending-corners': 'defending-corners',
  defending_corner: 'defending-corners',
  opponent_corner: 'defending-corners',
  opponent_corners: 'defending-corners',
  'opponent-corner': 'defending-corners',
  corners: 'attacking-corners',
  corner: 'attacking-corners',
  attacking_free_kicks: 'attacking-free-kicks',
  'attacking-free-kicks': 'attacking-free-kicks',
  attacking_free_kick: 'attacking-free-kicks',
  defending_free_kicks: 'defending-free-kicks',
  'defending-free-kicks': 'defending-free-kicks',
  defending_free_kick: 'defending-free-kicks',
  attacking_throw_ins: 'attacking-throw-ins',
  'attacking-throw-ins': 'attacking-throw-ins',
  attacking_throw_in: 'attacking-throw-ins',
  defending_throw_ins: 'defending-throw-ins',
  'defending-throw-ins': 'defending-throw-ins',
  defending_throw_in: 'defending-throw-ins',
  throw_ins: 'attacking-throw-ins',
...
const SECTION_LABELS = {
  ...
  'attacking-corners': { en: 'Attacking corners', it: 'Calci d’angolo offensivi' },
  'defending-corners': { en: 'Defending corners', it: 'Calci d’angolo difensivi' },
  'attacking-free-kicks': { en: 'Attacking free kicks', it: 'Punizioni offensive' },
  'defending-free-kicks': { en: 'Defending free kicks', it: 'Punizioni difensive' },
  'attacking-throw-ins': { en: 'Attacking throw-ins', it: 'Rimesse laterali offensive' },
  'defending-throw-ins': { en: 'Defending throw-ins', it: 'Rimesse laterali difensive' },
