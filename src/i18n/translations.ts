...
const dictionaries = {
  en: {
    ...
    statsHint:
      'Club rankings by competition — Primavera 2, Coppa Italia, UEFA Youth League — then General, Offensive, Defensive, or Possession. Napoli is highlighted in each table.',
    statsEmpty: 'No metrics in this category yet.',
    statsEmptyCompetition:
      'No match metrics logged for this competition yet. Rankings appear when team sheets are added.',
    statsSeasonAvg: 'Season average: {value}',
    statsUsValue: 'Napoli: {value}',
    statsColRank: '#',
    statsColDate: 'Date',
    statsColOpponent: 'Opponent',
    statsColTeam: 'Team',
    statsColPlayed: 'P',
    statsColValue: 'Value',
    statsTabGeneral: 'General',
    statsTabOffensive: 'Offensive',
    statsTabDefensive: 'Defensive',
    statsTabPossession: 'Possession',
    statsCompetitionAria: 'Competition',
    statsCategoryAria: 'Metric group',
    ...
    gpsReportTitle: 'GPS Analysis (K-SPORT)',
    gpsColPlayer: 'Player',
    gpsColTotalDist: 'Dist (m)',
    gpsColDistPerMin: 'm/min',
    gpsColOver16: '>16 km/h',
    gpsCol20to24: '20–24 km/h',
    gpsColOver24: '>24 km/h',
    gpsColMetPower: 'Met. power',
    gpsColAcc: 'Acc >3',
    gpsColDec: 'Dec <−3',
    gpsColMaxSpeed: 'Smax',
    gpsColRecovery: 'Recovery',
  ...
  it: {
    ...
    statsHint:
      'Classifiche di club per competizione — Primavera 2, Coppa Italia, UEFA Youth League — poi Generale, Offensiva, Difensiva o Possesso. Napoli è evidenziato in ogni tabella.',
    statsEmpty: 'Nessuna metrica in questa categoria.',
    statsEmptyCompetition:
      'Nessuna metrica di partita per questa competizione. Le classifiche compaiono quando aggiungi i fogli squadra.',
    statsSeasonAvg: 'Media stagione: {value}',
    statsUsValue: 'Napoli: {value}',
    statsColRank: '#',
    statsColDate: 'Data',
    statsColOpponent: 'Avversario',
    statsColTeam: 'Squadra',
    statsColPlayed: 'G',
    statsColValue: 'Valore',
    statsTabGeneral: 'Generale',
    statsTabOffensive: 'Offensiva',
    statsTabDefensive: 'Difensiva',
    statsTabPossession: 'Possesso',
    statsCompetitionAria: 'Competizione',
    statsCategoryAria: 'Gruppo metriche',
    ...
    gpsReportTitle: 'Analisi GPS (K-SPORT)',
    gpsColPlayer: 'Giocatore',
    gpsColTotalDist: 'Dist (m)',
    gpsColDistPerMin: 'm/min',
    gpsColOver16: '>16 km/h',
    gpsCol20to24: '20–24 km/h',
    gpsColOver24: '>24 km/h',
    gpsColMetPower: 'Pot. met.',
    gpsColAcc: 'Acc >3',
    gpsColDec: 'Dec <−3',
    gpsColMaxSpeed: 'Smax',
    gpsColRecovery: 'Recovery',
