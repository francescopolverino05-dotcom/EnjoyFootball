...
const dictionaries = {
  en: {
    ...
    coachBriefingTitle: 'Coach briefing',
    coachBriefingHint:
      'Staff meeting pack — headline, takeaways, next training priorities, and the clips to review together.',
    coachBriefingDraft: 'Draft preview',
    coachBriefingForStaff: 'For the coaching staff',
    coachBriefingTakeaways: 'Key takeaways',
    coachBriefingPriorities: 'Training priorities',
    coachBriefingKeyClips: 'Clips for the meeting',
    coachBriefingClipCount: '{n} clips',
    coachBriefingOpenClip: 'Open in clips tab →',
    coachBriefingReviewAllClips: 'Review all match clips →',
    coachBriefingOpenDashboard: 'Open match dynamics →',
  ...
  it: {
    ...
    coachBriefingTitle: 'Briefing mister',
    coachBriefingHint:
      'Pacchetto per lo staff — titolo, punti chiave, priorità di allenamento e clip da rivedere insieme.',
    coachBriefingDraft: 'Anteprima bozza',
    coachBriefingForStaff: 'Per lo staff tecnico',
    coachBriefingTakeaways: 'Punti chiave',
    coachBriefingPriorities: 'Priorità di allenamento',
    coachBriefingKeyClips: 'Clip per la riunione',
    coachBriefingClipCount: '{n} clip',
    coachBriefingOpenClip: 'Apri nel tab clip →',
    coachBriefingReviewAllClips: 'Rivedi tutte le clip →',
    coachBriefingOpenDashboard: 'Apri le dinamiche →',
