...
const dictionaries = {
  en: {
    ...
    homeDashboard: 'FPFootPortal — Dashboard',
    homeHeroTitle: 'Match & Training Analysis',
    homeHeroBody:
      'FPFootPortal — all Primavera (U19) match and training analysis in one place for the coaching staff.',
  ...
  it: {
    ...
    homeHeroBody:
      'FPFootPortal — tutte le analisi della Primavera (U19) in un unico posto per lo staff tecnico.',
