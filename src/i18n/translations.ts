...
const dictionaries = {
  en: {
    ...
    playerMatchActivity: 'Matches & clips',
    playerMatchActivityHint:
      'Appearances linked from match sheets, plus clips tagged to this player. Draft clip tags are marked.',
    playerMatchesCount: 'Matches',
    playerClipsCount: 'Clips',
    playerGoalsCount: 'Goals',
    playerNoMatchLinks: 'No linked matches or clips yet for this player.',
    playerMinutes: 'Minutes / status',
    playerTaggedClips: 'Tagged clips',
    playerNoTaggedClips: 'No tagged clips yet',
    playerDraftClipTag: 'Draft tag',
    playerOpenInMatch: 'Open in match →',
    playerOpenReport: 'Open report →',
    playerClipsAvailable: '{n} clips ready',
    playerDraftPreview: 'Draft preview',
    playerLinkSourceAppearances: 'From team sheet',
    playerLinkSourceFormation: 'From formation (draft)',
    playerLinkSourceGoals: 'From goals',
    navHome: 'Home',
  ...
  it: {
    ...
    playerMatchActivity: 'Partite e clip',
    playerMatchActivityHint:
      'Presenze collegate dal referto, più clip taggate a questo giocatore. I tag bozza sono evidenziati.',
    playerMatchesCount: 'Partite',
    playerClipsCount: 'Clip',
    playerGoalsCount: 'Gol',
    playerNoMatchLinks: 'Nessuna partita o clip collegata ancora per questo giocatore.',
    playerMinutes: 'Minuti / stato',
    playerTaggedClips: 'Clip taggate',
    playerNoTaggedClips: 'Nessuna clip taggata ancora',
    playerDraftClipTag: 'Tag bozza',
    playerOpenInMatch: 'Apri in partita →',
    playerOpenReport: 'Apri report →',
    playerClipsAvailable: '{n} clip pronte',
    playerDraftPreview: 'Anteprima bozza',
    playerLinkSourceAppearances: 'Dal tabellino',
    playerLinkSourceFormation: 'Dalla formazione (bozza)',
    playerLinkSourceGoals: 'Dai gol',
    navHome: 'Home',
